...
all_columns_randolph_type_station = [
    "Date & Time",
    "Inside Temp - °F",
    "High Inside Temp - °F",
    "Low Inside Temp - °F",
...
columns_unwanted_randolph_type_station = [
    "Inside Temp - °F",
    "High Inside Temp - °F",
    "Low Inside Temp - °F",
    "Inside Hum - %",
...
columns_wanted_randolph_type_station = ["Temp 1 - °F", "Temp 2 - °F", "Leaf Wetness 1", "Leaf Wetness 2"]
columns_wanted_singleton_station = ["Temp 1 - °F", "Leaf Wetness 1"]
columns_wanted_singleton_water_tables_low_gap_station = ["Temp 2 - °F", "Leaf Wetness 2"]
